...
<!--header-->
<div class="header" style="background: #0ea4d6">
    <div class="container">
        <nav class="navbar navbar-default" role="navigation">
            <div class="navbar-header">
                ...
                <h1 class="navbar-brand"><a href="index.action">@An书店</a></h1>
            </div>
            <!--navbar-header-->
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li><a href="index.action" <c:if test="${param.flag==1}">class="active"</c:if>>首  页</a></li>
                    <li><a href="recommend_books.action?rtype=2&pageNumber=1" <c:if test="${param.flag==3 && t==2}">class="active"</c:if>>热销书籍</a></li>
                    <li><a href="recommend_books.action?rtype=3&pageNumber=1" <c:if test="${param.flag==3 && t==3}">class="active"</c:if>>新品书籍</a></li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle <c:if test="${param.flag==2}">active</c:if>" data-toggle="dropdown">书籍分类<b class="caret"></b></a>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <ul class="multi-column-dropdown">
                                            <li><a class="list" href="booktypes_list.action?pageNumber=1&btid=-1">所有系列</a></li>
                    ...
                    <c:otherwise>
                        <li><a href="showCou2.action">领取优惠券</a></li>
                        <li><a href="order_list.action" <c:if test="${param.flag==5 }">class="active"</c:if>>我的订单</a></li>
                            <li><a href="selectOneUcouponByid.action" <c:if test="${param.flag==4 }">class="active"</c:if>>个人中心</a></li>
                            <li><a href="logout.action" >退出</a></li>
                            <c:if test="${user.isadmin}">
                                <li><a href="admin/index.jsp" target="_blank">后台管理中心</a></li>
                            </c:if>
                    </c:otherwise>
                    </c:choose>
                </ul>
