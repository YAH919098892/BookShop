...
<body style="background-color: rgba(146,208,214,0.33)">
<!--header-->
...
<div class="banner">
    <div class="container" >
        <h2 class="hdng"><a href="book_detail.action?bid=${scrollBook.bid}" style="color: #00a0dc">${scrollBook.bname}</a><span></span></h2>
        <p style="color: #d43f3a">今日推荐</p>
        <a class="banner_a" href="javascript:;" onclick="buy(${scrollBook.bid})" style="color: #00a0dc;font-style: italic;border-color: #0ea4d6">加入购物车</a>
        <div class="banner-text" style="color: #00a0dc">
            <a href="book_detail.action?bid=${scrollBook.bid}" style="background-color: #00a0dc ">
            ...
            <c:forEach items="${hotList}" var="book">
                <div class="col-md-4 gallery-grid glry-two">
                    ...
                    <div class="gallery-info galrr-info-two">
                        ...
                        <a class="shop" href="javascript:;" onclick="buy(${book.bid})">加入购物车</a>
            ...
            <c:forEach items="${newList}" var="book">
                <div class="col-md-3 gallery-grid ">
                    ...
                    <div class="gallery-info">
                        <p>
                            <span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span>
                            <a href="book_detail.action?bid=${book.bid}">查看书籍</a>
                        </p>
